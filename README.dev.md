# `salmon` developer documentation
...
# install salmon as an editable package
...
The second is to use `tox`, which can be installed separately (e.g. with `pip install tox`), i.e. not necessarily inside the virtual environment you use for installing `salmon`, but then builds the necessary virtual environments itself by simply running:
...
cd $(mktemp -d salmon.XXXXXX)
git clone git@github.com:fdiblen/salmon .
...
Visit
[https://test.pypi.org/project/salmon](https://test.pypi.org/project/salmon)
and verify that your package was uploaded successfully. Keep the terminal open, we'll need it later.

In a new terminal, without an activated virtual environment or an env directory:

```shell
cd $(mktemp -d salmon-test.XXXXXX)
...
--extra-index-url https://pypi.org/simple salmon
```
...
Don't forget to also make a [release on GitHub](https://github.com/fdiblen/salmon/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.